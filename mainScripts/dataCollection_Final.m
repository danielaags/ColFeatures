function[data] =dataCollection_Final(filename)
...
data = struct('label', labelAll, 'sample', sampleAll, 'ID', idAll,...
    'centroid', centroidAll, 'area', areaAll, 'diameter', diameterAll,...
    'perimeter', perimeterAll, 'peaks', peaksAll, 'height_peaks', height_peaksAll,...
